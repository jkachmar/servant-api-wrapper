...
import           Api.Server.Occupancy

-- | This function tells Servant how to run the 'App' monad with our
-- 'server' function.
appToServer :: Config -> Server OccupancyAPI
appToServer cfg = enter (convertApp cfg) cameraServer
